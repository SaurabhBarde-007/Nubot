...
const Card = (props) => {
  ...
  return (
    <motion.button whileHover={{scale:1.05}} className='w-[300px] sm:w-[450px] h-[90px] bg-[#000] flex justify-center content-center self-center rounded-lg gap-4 p-[20px]' onClick={()=>{
      func();
    }}>
